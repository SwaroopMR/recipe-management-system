...
const PREDEFINED_RECIPES = [
  ...
  },
  {
    ...
    name: "Baingan Bharta",
    description: "Smoky roasted eggplant mashed and cooked with onions, tomatoes, ginger, garlic, and fragrant Indian spices. A Punjabi household classic.",
    ingredients: ["1 large eggplant (bharta baingan)", "2 tbsp mustard oil", "1 tsp cumin seeds", "1 large onion, finely chopped", "1 tbsp ginger-garlic paste", "2 green chilies, slit", "2 large tomatoes, finely chopped", "1/2 tsp turmeric powder", "1 tsp Kashmiri red chili powder", "1 tsp garam masala", "1/4 cup fresh coriander, chopped", "Salt to taste"],
    instructions: ["Wash the eggplant, make a few slits, and brush with oil. Roast directly on a gas flame or bake until skin is charred and flesh is tender.", "Cool, peel off the charred skin, and mash the flesh with a fork.", "Heat mustard oil in a pan until it smokes. Add cumin seeds and let them splutter.", "Add chopped onions, green chilies, and ginger-garlic paste. Sauté until onions are golden brown.", "Add chopped tomatoes, turmeric, red chili powder, and salt. Cook until tomatoes turn mushy and oil separates.", "Add the mashed eggplant and mix thoroughly. Cook on medium-low heat for 10 minutes, stirring occasionally.", "Stir in garam masala and garnish with fresh coriander. Serve hot with roti or paratha."],
    preparation_time: 15,
    cooking_time: 25,
    servings: 4,
    category: "Dinner",
    ...
    tags: ["eggplant", "vegan", "smoky", "curry", "traditional"],
    created_at: "2026-06-23T00:00:00Z",
    updated_at: "2026-06-23T00:00:00Z"
  },
  {
    ...
    cuisine: "North Indian",
    image_url: "https://images.unsplash.com/photo-1596797038530-2c107229654b?auto=format&fit=crop&w=800&q=80",
    tags: ["aloo", "gobi", "vegan", "dry-curry", "lunch"],
    created_at: "2026-06-23T00:00:00Z",
    updated_at: "2026-06-23T00:00:00Z"
  },
  {
    ...
    cuisine: "North Indian",
    image_url: "https://images.unsplash.com/photo-1596797038530-2c107229654b?auto=format&fit=crop&w=800&q=80",
    tags: ["okra", "bhindi", "vegan", "stir-fry", "lunch"],
    created_at: "2026-06-23T00:00:00Z",
    updated_at: "2026-06-23T00:00:00Z"
  },
  {
    id: "fb444444-4444-4444-4444-444444444444",
    name: "Chana Palak",
    description: "Protein-packed chickpeas cooked in a healthy, spiced spinach gravy. Vegan and highly nutritious.",
    ingredients: ["1.5 cups chickpeas, boiled", "1 large bunch spinach (palak)", "1 tbsp oil", "1 tsp cumin seeds", "1 medium onion, finely chopped", "1 tsp ginger-garlic paste", "2 tomatoes, pureed", "1/2 tsp turmeric powder", "1 tsp garam masala", "Salt to taste"],
    instructions: ["Blanch the spinach in boiling water for 2 minutes, then plunge into cold water to retain color. Puree in a blender.", "Heat oil in a pan. Add cumin seeds and let them splutter.", "Add chopped onions and ginger-garlic paste. Sauté until golden brown.", "Add tomato puree, turmeric, and salt. Cook until the mixture thickens and releases oil.", "Add the boiled chickpeas and blanched spinach puree. Add a little water if too thick.", "Simmer on medium heat for 8-10 minutes so chickpeas absorb the spinach flavor.", "Stir in garam masala and serve hot with steamed basmati rice or flatbreads."],
    preparation_time: 15,
    cooking_time: 20,
    servings: 4,
    category: "Dinner",
    ...
    tags: ["spinach", "chickpeas", "vegan", "healthy", "dinner"],
    created_at: "2026-06-23T00:00:00Z",
    updated_at: "2026-06-23T00:00:00Z"
  },
  {
    id: "fb555555-5555-5555-5555-555555555555",
    name: "Paneer Tikka Masala",
    description: "Tandoori grilled paneer cubes marinated in yogurt and spices, served in a rich, creamy, and spiced tomato-based gravy.",
    ingredients: ["250g paneer, cut into cubes", "1 bell pepper and 1 onion, cut into petals", "1/2 cup yogurt", "1 tbsp ginger-garlic paste", "2 tsp Kashmiri red chili powder", "1/2 tsp turmeric powder", "1 tsp garam masala", "1 tbsp lemon juice", "2 tbsp mustard oil", "1 onion chopped", "2 tomatoes pureed", "1/4 cup heavy cream", "1 tbsp butter", "cashew paste (10 cashews)", "Salt to taste"],
    instructions: ["In a bowl, mix yogurt, ginger-garlic paste, red chili powder, turmeric, garam masala, salt, lemon juice, and mustard oil. Marinate paneer, bell pepper, and onion petals for 30 minutes.", "Skewer paneer and vegetables and grill in an oven or pan until lightly charred. Set aside.", "For gravy, heat butter and oil in a pan. Sauté chopped onions until golden.", "Add tomato puree, cashew paste, remaining spices, and salt. Cook until oil separates.", "Add 1/2 cup water and bring to a simmer. Add grilled paneer and veggies.", "Stir in heavy cream, simmer for 3 minutes, and garnish with coriander. Serve with garlic naan."],
    preparation_time: 20,
    cooking_time: 20,
    servings: 4,
    category: "Dinner",
    ...
    cuisine: "North Indian",
    image_url: "https://images.unsplash.com/photo-1631452180519-c014fe946bc7?auto=format&fit=crop&w=800&q=80",
    tags: ["paneer", "tikka", "creamy", "vegetarian", "dinner"],
    created_at: "2026-06-23T00:00:00Z",
    updated_at: "2026-06-23T00:00:00Z"
  },
  {
    id: "fb666666-6666-6666-6666-666666666666",
    name: "Medu Vada",
    description: "Crispy, savory fried lentil donuts made from a fluffy skinless black gram batter, flavored with peppercorns and curry leaves.",
    ingredients: ["1 cup whole white urad dal (black gram), soaked for 4 hours", "2 green chilies, chopped", "1 inch ginger, chopped", "1 sprig curry leaves, chopped", "1 tsp whole black peppercorns", "A pinch of asafoetida (hing)", "Oil for deep frying", "Salt to taste"],
    instructions: ["Drain soaked urad dal completely. Grind in a blender, adding very little ice-cold water, to make a thick, fluffy batter.", "Whip the batter vigorously with your hand for 5 minutes to incorporate air (batter should float in water).", "Mix in green chilies, ginger, curry leaves, black peppercorns, hing, and salt.", "Wet your palms. Take a portion of batter, shape it into a ball, and make a hole in the center with your thumb.", "Gently slide the shaped vada into hot oil. Fry on medium heat until golden and crispy on both sides.", "Drain on paper towels and serve immediately with hot sambar and coconut chutney."],
    preparation_time: 20,
    cooking_time: 20,
    servings: 4,
    category: "Breakfast",
  ...
  },
  {
    ...
    cuisine: "North Indian",
    image_url: "https://images.unsplash.com/photo-1631452180519-c014fe946bc7?auto=format&fit=crop&w=800&q=80",
    tags: ["kofta", "creamy", "vegetarian", "festive", "dinner"],
    created_at: "2026-06-23T00:00:00Z",
    updated_at: "2026-06-23T00:00:00Z"
  },
  {
    id: "fb999999-9999-9999-9999-999999999999",
    name: "Kadhi Pakora",
    description: "A traditional Punjabi dish of spiced gram flour fritters (pakoras) submerged in a tangy, spiced yogurt and chickpea flour gravy.",
    ingredients: ["1 cup yogurt (sour preferred)", "1/2 cup gram flour (besan)", "1/2 tsp turmeric powder", "1 tsp red chili powder", "1 cup besan (for pakora)", "1 onion sliced (for pakora)", "1/2 tsp chili powder (for pakora)", "Water", "Oil for frying", "1 tbsp oil (for tempering)", "1/2 tsp mustard seeds", "1/2 tsp fenugreek seeds (methi)", "1 pinch hing", "2 dry red chilies", "10 curry leaves"],
    instructions: ["Whisk yogurt, 1/2 cup besan, turmeric, chili powder, and 3 cups of water into a lump-free, thin mixture.", "Pour the mixture into a deep pot, bring to a boil, then simmer on low heat for 30 minutes, stirring occasionally.", "For pakoras, mix besan, sliced onions, chili powder, salt, and water to make a thick batter. Spoon portions into hot oil and fry until golden-brown.", "Add the fried pakoras to the simmering yogurt gravy.", "Heat oil in a small pan, add mustard seeds, fenugreek seeds, hing, dry red chilies, and curry leaves. Let them splutter.", "Pour the hot tempering over the kadhi, cover for 5 minutes, and serve with steamed rice."],
    preparation_time: 20,
    cooking_time: 30,
    servings: 4,
    category: "Lunch",
    ...
    cuisine: "Punjabi",
    image_url: "https://images.unsplash.com/photo-1546833999-b9f581a1996d?auto=format&fit=crop&w=800&q=80",
    tags: ["kadhi", "pakora", "yogurt", "vegetarian", "traditional"],
    created_at: "2026-06-23T00:00:00Z",
    updated_at: "2026-06-23T00:00:00Z"
  },
  {
    ...
    name: "Matar Paneer",
    description: "A popular, everyday North Indian curry of soft paneer cubes and green peas simmered in a spiced onion-tomato gravy.",
    ingredients: ["200g paneer, cubed", "1 cup green peas (matar), fresh or frozen", "1 large onion, chopped", "2 medium tomatoes, chopped", "1 tbsp ginger-garlic paste", "1 tsp cumin seeds", "1 tsp coriander powder", "1/2 tsp turmeric powder", "1/2 tsp red chili powder", "1/2 tsp garam masala", "2 tbsp oil or ghee", "Salt to taste"],
    instructions: ["Heat oil in a pan, lightly toast paneer cubes until golden, then soak in warm water to keep soft. Drain and set aside.", "In the same pan, add cumin seeds. Sauté onions and ginger-garlic paste until golden brown.", "Add chopped tomatoes and cook until soft and mushy.", "Add coriander powder, turmeric, red chili powder, and salt. Cook until oil separates.", "Add the peas and 1 cup of water, simmer for 5 minutes until peas are tender.", "Add paneer cubes and garam masala, cooking for 3 minutes on low heat.", "Garnish with fresh coriander and serve warm with roti or paratha."],
    preparation_time: 15,
    cooking_time: 20,
    servings: 4,
    category: "Lunch",
    ...
    cuisine: "North Indian",
    image_url: "https://images.unsplash.com/photo-1631452180519-c014fe946bc7?auto=format&fit=crop&w=800&q=80",
    tags: ["paneer", "matar", "peas", "vegetarian", "lunch"],
    created_at: "2026-06-23T00:00:00Z",
    updated_at: "2026-06-23T00:00:00Z"
  },
  {
    ...
    name: "Jeera Aloo",
    description: "Super quick and delicious dry potato dish sautéed with abundance of cumin seeds, ginger, green chilies, and basic spices.",
    ingredients: ["4 medium potatoes, boiled, peeled and cubed", "2 tbsp oil or ghee", "1.5 tsp cumin seeds (jeera)", "1 inch ginger, finely chopped", "2 green chilies, chopped", "1/2 tsp turmeric powder", "1 tsp coriander powder", "1/2 tsp red chili powder", "1/2 tsp amchur (dry mango powder)", "Salt to taste", "Coriander for garnish"],
    instructions: ["Heat oil or ghee in a pan. Add cumin seeds and let them sizzle and turn fragrant.", "Add chopped ginger and green chilies. Sauté for a minute.", "Add turmeric powder, coriander powder, and red chili powder. Stir quickly on low heat so spices don't burn.", "Add the cubed boiled potatoes and salt. Toss gently to combine and coat the potatoes with spices.", "Cook on medium heat for 5-7 minutes until the potato edges get slightly crispy.", "Sprinkle dry mango powder (amchur) and fresh coriander.", "Mix well and serve hot with parathas or as a side dish with lentils."],
    preparation_time: 10,
    cooking_time: 10,
    servings: 3,
    category: "Quick Meals",
  ...
  },
  {
    ...
    cuisine: "Gujarati",
    image_url: "https://images.unsplash.com/photo-1606491956689-2ea866880c84?auto=format&fit=crop&w=800&q=80",
    tags: ["dhokla", "steamed", "gujarati", "quick", "vegetarian"],
    created_at: "2026-06-23T00:00:00Z",
    updated_at: "2026-06-23T00:00:00Z"
  },
  {
    id: "fc666666-6666-6666-6666-666666666666",
    name: "Sabudana Khichdi",
    description: "A popular gluten-free Maharashtrian breakfast dish made of tapioca pearls (sabudana) tossed with peanuts, green chilies, and potatoes.",
    ingredients: ["1 cup tapioca pearls (sabudana), soaked overnight", "1/2 cup raw peanuts, roasted and coarsely ground", "2 tbsp oil or ghee", "1 tsp cumin seeds", "1 medium potato, boiled and cubed", "2 green chilies, finely chopped", "1 tbsp lemon juice", "Fresh coriander chopped", "Salt to taste"],
    instructions: ["Ensure sabudana is well-soaked and drained. Grains should mash easily between fingers without being sticky.", "Mix the coarsely ground roasted peanuts and salt into the soaked sabudana.", "Heat oil or ghee in a pan. Add cumin seeds and let them splutter.", "Add green chilies and potato cubes. Sauté for 2-3 minutes.", "Add the sabudana-peanut mixture to the pan. Stir gently to combine.", "Cover and cook on low heat for 5 minutes, until the sabudana pearls turn translucent.", "Remove cover, stir in lemon juice and chopped coriander. Serve hot."],
    preparation_time: 15,
    cooking_time: 15,
    servings: 2,
    category: "Healthy",
    ...
    cuisine: "Maharashtrian",
    image_url: "https://images.unsplash.com/photo-1601050690597-df056fb4ce78?auto=format&fit=crop&w=800&q=80",
    tags: ["tapioca", "healthy", "breakfast", "vegan", "fasting"],
    created_at: "2026-06-23T00:00:00Z",
    updated_at: "2026-06-23T00:00:00Z"
  },
  {
    id: "fc777777-7777-7777-7777-777777777777",
    name: "Rajma Masala",
    description: "Red kidney beans slow-cooked in a robust onion-tomato gravy with warm spices. A comforting staple in North Indian homes.",
    ingredients: ["1 cup red kidney beans (rajma), soaked overnight", "2 tbsp oil or ghee", "1 tsp cumin seeds", "1 large onion, finely chopped", "1 tbsp ginger-garlic paste", "2 tomatoes, pureed", "1/2 tsp turmeric powder", "1 tsp red chili powder", "1 tsp coriander powder", "1/2 tsp garam masala", "Salt to taste"],
    instructions: ["Pressure cook soaked kidney beans in 3 cups of water with salt until perfectly soft and melt-in-mouth (about 5-6 whistles).", "Heat oil or ghee in a large pot. Add cumin seeds and let them splutter.", "Add chopped onions and ginger-garlic paste. Sauté until dark golden brown.", "Add tomato puree, turmeric, red chili powder, and coriander powder. Sauté until the paste starts leaving oil.", "Add the cooked kidney beans along with their cooking water. Mash a few beans with the back of a spoon to thicken gravy.", "Simmer on low-medium heat for 15-20 minutes until the gravy thickens and flavors meld.", "Stir in garam masala and garnish with fresh coriander. Serve hot with steamed basmati rice (Rajma Chawal)."],
    preparation_time: 15,
    cooking_time: 30,
    servings: 4,
    category: "Dinner",
    difficulty: "Medium",
    cuisine: "Punjabi",
    image_url: "https://images.unsplash.com/photo-1622396481328-9b1b78cdd9fd?auto=format&fit=crop&w=800&q=80",
    tags: ["rajma", "kidney-beans", "vegan", "curry", "dinner"],
    created_at: "2026-06-23T00:00:00Z",
    updated_at: "2026-06-23T00:00:00Z"
  },
  {
    id: "fc888888-8888-8888-8888-888888888888",
    name: "Kashmiri Dum Aloo",
    description: "Baby potatoes deep-fried and slow-cooked in a rich, spicy, and tangy yogurt gravy seasoned with fennel and dry ginger powder.",
    ingredients: ["15 baby potatoes, boiled and peeled", "1 cup yogurt (curd), whisked", "2 tbsp mustard oil", "1/2 tsp cumin seeds", "1 pinch asafoetida (hing)", "2 tsp fennel powder (saunf)", "1 tsp dry ginger powder (sonth)", "2 tsp Kashmiri red chili powder", "1/2 tsp garam masala", "Salt to taste"],
    instructions: ["Prick peeled baby potatoes all over with a toothpick. Deep fry or pan fry until they get a golden, crispy skin. Set aside.", "In a bowl, mix whisked yogurt, fennel powder, ginger powder, red chili powder, and salt.", "Heat mustard oil in a pot. Add cumin seeds and hing.", "Lower the heat completely and slowly pour in the yogurt-spice mixture, stirring continuously to prevent yogurt from curdling.", "Add the fried baby potatoes and 1/2 cup of water. Mix well.", "Cover the pot tightly with a lid and cook on low heat for 15-20 minutes (dum) until potatoes absorb the gravy.", "Sprinkle garam masala and serve hot with naan or steamed rice."],
    preparation_time: 20,
    cooking_time: 30,
    servings: 3,
    category: "Dinner",
    ...
    cuisine: "Kashmiri",
    image_url: "https://images.unsplash.com/photo-1596797038530-2c107229654b?auto=format&fit=crop&w=800&q=80",
    tags: ["aloo", "kashmiri", "spicy", "vegetarian", "dinner"],
    created_at: "2026-06-23T00:00:00Z",
    updated_at: "2026-06-23T00:00:00Z"
  },
  {
    id: "fc999999-9999-9999-9999-999999999999",
    name: "Bisi Bele Bath",
    description: "A traditional, spicy, and tangy rice-lentil dish from Karnataka, packed with mixed vegetables, tamarind, and a special spice powder.",
    ingredients: ["1/2 cup Basmati rice", "1/2 cup split yellow pigeon peas (toor dal)", "1 cup mixed vegetables (carrots, beans, peas, potato)", "2 tbsp Bisi Bele Bath powder", "1 tbsp tamarind paste", "2 tbsp ghee or oil", "1 tsp mustard seeds", "10 curry leaves", "2 tbsp cashews, roasted", "Salt to taste"],
    instructions: ["Wash rice and toor dal. Cook them together in a pressure cooker with 4 cups of water and turmeric until completely soft and mushy.", "In a large pot, boil the chopped mixed vegetables in water with a pinch of salt until tender.", "Add the cooked rice-dal mixture, tamarind paste, Bisi Bele Bath powder, and salt to the pot of vegetables. Mix well.", "Simmer on low-medium heat for 10 minutes, stirring frequently so it does not stick to the bottom. Add water if it gets too dry; it should have a thick, porridge-like consistency.", "For tempering, heat ghee or oil in a pan. Sauté mustard seeds, curry leaves, and cashews until golden.", "Pour the hot tempering over the rice dish and mix well. Serve hot with potato chips or papadum."],
    preparation_time: 20,
    cooking_time: 30,
    servings: 4,
    category: "Traditional",
    ...
    tags: ["rice", "lentils", "south-indian", "traditional", "vegetarian"],
    created_at: "2026-06-23T00:00:00Z",
    updated_at: "2026-06-23T00:00:00Z"
  },
  {
    ...
    name: "Rava Kesari",
    description: "A classic South Indian sweet pudding made of semolina, sugar, ghee, cardamom, and roasted nuts, tinted with saffron.",
    ingredients: ["1/2 cup semolina (suji/rava)", "1 cup sugar", "1/4 cup ghee", "1.5 cups water", "10 cashews, chopped", "1 tbsp raisins", "1/4 tsp cardamom powder", "A few strands of saffron, soaked in 1 tbsp warm milk"],
    instructions: ["Heat 1 tablespoon of ghee in a pan and roast cashews and raisins until golden. Set aside.", "In the same pan, roast semolina on medium-low heat until fragrant (do not let it brown, about 5 minutes). Remove and set aside.", "Bring water to a boil in a saucepan. Lower the heat and slowly pour in the roasted semolina, stirring constantly to avoid lumps.", "Cover and cook on low heat for 2 minutes until semolina absorbs the water and cooks.", "Add sugar and remaining ghee. The mixture will turn liquidy again. Stir continuously until sugar dissolves and it starts thickening.", "Add the saffron milk, cardamom powder, roasted cashews, and raisins.", "Stir until the pudding leaves the sides of the pan. Serve warm."],
    preparation_time: 5,
    cooking_time: 15,
    servings: 4,
    category: "Dessert",
    ...
    tags: ["halwa", "sweet", "dessert", "saffron", "vegetarian"],
    created_at: "2026-06-23T00:00:00Z",
    updated_at: "2026-06-23T00:00:00Z"
  },
  {
    ...
    description: "A classic and healthy South Indian dipping sauce made of freshly grated coconut, roasted chickpeas, and chilies, tempered with curry leaves.",
    ingredients: ["1 cup fresh coconut, grated", "2 tbsp roasted split chickpeas (dalia)", "2 green chilies", "1 inch ginger", "Salt to taste", "1 tsp oil (for tempering)", "1/2 tsp mustard seeds", "1 dry red chili", "5-6 curry leaves", "a pinch of hing"],
    instructions: ["In a blender, combine grated coconut, roasted chickpeas, green chilies, ginger, salt, and 1/2 cup of water.", "Blend into a smooth paste. Add more water if a thinner consistency is desired. Transfer to a bowl.", "For tempering, heat oil in a small pan on medium heat.", "Add mustard seeds and let them crackle.", "Add dry red chili, curry leaves, and a pinch of hing. Fry for 10-15 seconds.", "Pour this hot tempering over the coconut paste and stir. Serve chilled or at room temperature with idli or dosa."],
    preparation_time: 10,
    cooking_time: 2,
    servings: 6,
    category: "Healthy",
    ...
    tags: ["coconut", "chutney", "healthy", "vegan", "condiment"],
    created_at: "2026-06-23T00:00:00Z",
    updated_at: "2026-06-23T00:00:00Z"
  },
  {
    id: "fd333333-3333-3333-3333-333333333333",
    name: "Gujarati Khichdi and Kadhi",
    description: "Light and comforting rice and yellow lentil mixture paired with a warm, thin sweet-spicy yogurt soup (Kadhi).",
    ingredients: ["1/2 cup rice", "1/2 cup yellow split moong dal", "1 tsp ghee", "1/2 tsp turmeric powder", "Salt to taste", "1 cup yogurt (for kadhi)", "2 tbsp gram flour (besan) (for kadhi)", "1 tsp ginger-chili paste (for kadhi)", "1 tbsp sugar (for kadhi)", "1 tsp mustard seeds", "1 pinch hing", "5 curry leaves", "1 cinnamon stick", "2 cloves"],
    instructions: ["Wash rice and moong dal together. Cook in a pressure cooker with 4 cups of water, turmeric, and salt until very soft. Drizzle with ghee.", "For Kadhi, whisk yogurt, besan, ginger-chili paste, sugar, salt, and 2 cups of water until smooth.", "Pour into a saucepan, bring to a boil, and simmer for 10 minutes on low heat, stirring occasionally.", "In a small pan, heat 1 tsp ghee. Add mustard seeds, cinnamon, cloves, hing, and curry leaves. Let them splutter.", "Pour the hot tempering over the simmering kadhi and boil for 2 more minutes.", "Serve the hot, comforting Khichdi accompanied by the warm, sweet-tangy Kadhi."],
    preparation_time: 15,
    cooking_time: 25,
    servings: 3,
    category: "Healthy",
    ...
    cuisine: "Gujarati",
    image_url: "https://images.unsplash.com/photo-1546833999-b9f581a1996d?auto=format&fit=crop&w=800&q=80",
    tags: ["khichdi", "kadhi", "gujarati", "healthy", "comfort-food"],
    created_at: "2026-06-23T00:00:00Z",
    updated_at: "2026-06-23T00:00:00Z"
  },
  {
    ...
    name: "Shahi Tukda",
    description: "A royal bread pudding dessert from the Awadhi cuisine: deep-fried bread slices soaked in cardamom sugar syrup and topped with rabri (thick sweetened milk) and nuts.",
    ingredients: ["4 slices white bread, crusts removed", "3 cups whole milk", "1/2 cup sugar", "1/4 cup water", "4 tbsp ghee (for frying bread)", "1/4 tsp green cardamom powder", "A few saffron strands", "2 tbsp sliced almonds and pistachios"],
    instructions: ["For rabri, boil whole milk in a wide heavy-bottomed pan. Simmer on low heat, stirring frequently and scraping sides, until milk reduces to 1/3 of its volume and gets thick. Stir in 2 tbsp sugar, cardamom powder, and saffron. Set aside.", "In a separate pan, combine remaining sugar and water. Simmer for 5 minutes to make a thin cardamom syrup. Keep warm.", "Cut bread slices diagonally into triangles. Heat ghee in a pan and shallow-fry or deep-fry bread triangles until crispy and golden-brown.", "Dip the fried bread slices in the warm sugar syrup for 30 seconds, then place them on a serving plate.", "Pour the thick rabri generously over the soaked bread slices.", "Garnish with sliced almonds and pistachios and serve warm or chilled."],
    preparation_time: 15,
    cooking_time: 20,
    servings: 4,
    category: "Dessert",
    ...
    cuisine: "Mughlai",
    image_url: "https://images.unsplash.com/photo-1613292443284-8d10ef9383fe?auto=format&fit=crop&w=800&q=80",
    tags: ["sweet", "dessert", "royal", "creamy", "vegetarian"],
    created_at: "2026-06-23T00:00:00Z",
    updated_at: "2026-06-23T00:00:00Z"
  }
];
...
let fallbackCollectionRecipes = [
  ...
  { collection_id: '11111111-1111-1111-1111-111111111111', recipe_id: 'fb444444-4444-4444-4444-444444444444' },
  { collection_id: '11111111-1111-1111-1111-111111111111', recipe_id: 'fc666666-6666-6666-6666-666666666666' },
  { collection_id: '11111111-1111-1111-1111-111111111111', recipe_id: 'fd222222-2222-2222-2222-222222222222' },
  { collection_id: '11111111-1111-1111-1111-111111111111', recipe_id: 'fd333333-3333-3333-3333-333333333333' },
  ...
  { collection_id: '22222222-2222-2222-2222-222222222222', recipe_id: 'fb333333-3333-3333-3333-333333333333' },
  { collection_id: '22222222-2222-2222-2222-222222222222', recipe_id: 'fc222222-2222-2222-2222-222222222222' },
  { collection_id: '22222222-2222-2222-2222-222222222222', recipe_id: 'fc333333-3333-3333-3333-333333333333' },
  { collection_id: '22222222-2222-2222-2222-222222222222', recipe_id: 'fc555555-5555-5555-5555-555555555555' },
  ...
  { collection_id: '33333333-3333-3333-3333-333333333333', recipe_id: 'fb111111-1111-1111-1111-111111111111' },
  { collection_id: '33333333-3333-3333-3333-333333333333', recipe_id: 'fb555555-5555-5555-5555-555555555555' },
  { collection_id: '33333333-3333-3333-3333-333333333333', recipe_id: 'fb888888-8888-8888-8888-888888888888' },
  { collection_id: '33333333-3333-3333-3333-333333333333', recipe_id: 'fc999999-9999-9999-9999-999999999999' },
  ...
  { collection_id: '44444444-4444-4444-4444-444444444444', recipe_id: 'fb777777-7777-7777-7777-777777777777' },
  { collection_id: '44444444-4444-4444-4444-444444444444', recipe_id: 'fc444444-4444-4444-4444-444444444444' },
  { collection_id: '44444444-4444-4444-4444-444444444444', recipe_id: 'fc777777-7777-7777-7777-777777777777' },
  { collection_id: '44444444-4444-4444-4444-444444444444', recipe_id: 'fd444444-4444-4444-4444-444444444444' }
];
